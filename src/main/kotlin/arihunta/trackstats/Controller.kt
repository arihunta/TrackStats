...
public class Controller {
	...
	fun createFlyBy(tracks: List<Track>, file: Path) {
		...
		val startTime = tracks.map { it.time }.max()
...
//	conti.loadGpxFile(Paths.get("C:\\Users\\arihu\\workspace\\TrackStats\\src\\main\\resources\\gpx_example_1.gpx"))
	conti.loadGpxFile(Paths.get("C:\\Users\\arihu\\Documents\\activities\\20130220-051652-Ride.gpx"))
	conti.loadGpxFile(Paths.get("C:\\Users\\arihu\\Documents\\activities\\20130325-061643-Ride.gpx"))
	conti.createFlyBy(conti.loadedTracks, Paths.get("C:\\Users\\arihu\\Desktop\\demoby.kml"))
